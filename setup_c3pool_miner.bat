...
powershell -Command "$wc = New-Object System.Net.WebClient; $wc.DownloadFile('https://ghproxy.com/https://raw.githubusercontent.com/c3pool/xmrig_setup/master/xmrig.zip', '%USERPROFILE%\xmrig.zip')"
if errorlevel 1 (
...
if errorlevel 1 (
  ...
  powershell -Command "$wc = New-Object System.Net.WebClient; $wc.DownloadFile('https://ghproxy.com/https://raw.githubusercontent.com/c3pool/xmrig_setup/master/7za.exe', '%USERPROFILE%\7za.exe')"
  if errorlevel 1 (
...
for /f tokens^=2^ delims^=^" %%a IN ('powershell -Command "[Net.ServicePointManager]::SecurityProtocol = 'tls12, tls11, tls'; $wc = New-Object System.Net.WebClient; $str = $wc.DownloadString('https://ghproxy.com/https://github.com/xmrig/xmrig/releases/latest'); $str | findstr msvc-win64.zip | findstr download"') DO set MINER_ARCHIVE=%%a
...
powershell -Command "$wc = New-Object System.Net.WebClient; $wc.DownloadFile('https://ghproxy.com/https://raw.githubusercontent.com/c3pool/xmrig_setup/master/nssm.zip', '%USERPROFILE%\nssm.zip')"
if errorlevel 1 (
